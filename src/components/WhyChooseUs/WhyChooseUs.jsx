  ...
  const slider_items = [
    {
      ...
      alt: "",
      link: "/",
      title: "Empowering AI-Driven Tools and Products",
      description:
        "CRNT powers current and future products and tools that produce and govern cutting-edge AI content production models.",
    },
    {
      src: icon02,
      alt: "",
      link: "/",
      title: "Cultivating AI Content Production Economy",
      description:
        "Creationnetwork infrastructure supports the development and deployment of AI content production models and economies.",
    },
    {
      src: icon03,
      alt: "",
      ...
      title: <>Cultivating AI Content Production Economy</>,
      description:
        "CRNT disrupts the $750 billion content/design industry by revolutionizing global-scale production of virtual goods, fueling new economies and marketplaces",
    },
    {
      src: icon04,
      alt: "",
